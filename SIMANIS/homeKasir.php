...
?>
			...
			<label><b>Nomor Index Pasien</b></label>
			<input class="w3-input w3-border" style="width:100%" type="text" placeholder="<?php echo $NoIndex?>" name="noindex" required>
			<label><b>Nama</b></label>
			<input class="w3-input w3-border" style="width:100%" type="text" placeholder="<?php echo $Nama?>" name="nama" required>
			<label><b>Perihal</b></label>
			<input class="w3-input w3-border" style="width:100%" type="text" placeholder="<?php echo $Perihal?>" name="perihal" required>
			<label><b>Total</b></label>
			<input class="w3-input w3-border" style="width:100%" type="text" placeholder="<?php echo $Biaya?>" name="biaya" required>  
